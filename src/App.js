...
import ChatPage from "./pages/stress-relief";
import TuneCrafter from "./pages/tune-craft";
      ...
      <MoodContextProvider>
        <ContentContainer>
          ...
          <Routes>
            ...
            <Route path="/stress-relief" element={<ChatPage />} />
            <Route path="/tune-craft" element={<TuneCrafter />} />
          </Routes>
